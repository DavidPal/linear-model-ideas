...
It can be shown that with high probability the parameter $\theta$ lies in the set
$$
...
More importantly, it is possible to find a set $D_{\alpha, \delta} \subseteq
\R^d$ such that for any $x \in D_{\alpha,\delta}$ with probability at least $1 -
\delta$,
$$
...
$$
Note that $D_{\alpha,\delta}$ is an ellipsoid centered at the origin. The shape
